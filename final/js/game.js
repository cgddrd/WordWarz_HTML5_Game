...
var enemySpawnDelay = 0.035;
var healthSpawnProb = 0.06;
...
window.document.onkeydown = function(event) {
  ...
  if (keyCode >= 65 && keyCode <= 122 || keyCode == 189) {
...
/**
 * Obtains a new colletcion of words that will be used for the level.
 * @param levelDifficulty Current difficulty rating for the level.
 * @param wordLength The number of words to be generated. 
 */
...
function handleCollisions() {
	...
	var activeEnemies = enemies.filter(function(enemy) {
		return (enemy.active === true && enemy.used === false);
	});   
